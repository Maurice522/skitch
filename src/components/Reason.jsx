export default function Reason() {
    return (
        <>
            ...
            <div className="max-sm:ml-4 max-sm:p-0 max-md:w-[343px] max-sm:w-[85%] 2xl:ml-[25%] max-sm:h-[174px] flex flex-row mt-20 max-sm:gap-4 justify-center max-w-[1171px] gap-14 rounded-3xl shadow-card2 m-[5%] p-2">
