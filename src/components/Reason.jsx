export default function Reason() {
    return (
        <>
            ...
            <div className="flex flex-row items-center ml-[135px] max-sm:gap-0 gap-2 mt-20 max-sm:justify-start max-sm:ml-4 max-sm:mt-3">
            ...
            <div className="max-sm:ml-4 max-sm:p-0 max-sm:w-[95%] 2xl:ml-[25%] max-sm:h-[174px] flex flex-row mt-20 max-sm:gap-0 ml-[135px] w-[79%] gap-14 rounded-3xl shadow-card2 p-2">
                ...
                <div className="relative">
                    ...
                    <div className="absolute bottom-0 max-sm:top-[131px] right-0 flex flex-row gap-4 max-sm:gap-2">
                        ...
                        <button className="font-nav max-sm:p-0 font-semibold max-sm:text-[10px] max-sm:leading-[14px] text-base leading-[22px] bg-black text-white rounded-xl shadow-tap text-center max-sm:h-[32px] max-sm:w-[77px] w-[150px] p-2">TAP HERE</button>
                    </div>
                </div>
            </div>
        </>
