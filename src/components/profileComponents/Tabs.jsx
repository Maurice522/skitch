    ...
    return (
        <>
            ...
            <div className="md:border max-md:border-b-2 max-md:p-2 max-md:border-solid max-md-border-[#909090] md:border-solid md:border-[#E1E1E1] md:rounded-lg md:w-[142px] md:h-[50px] md:text-center">
                <div style={{cursor:"pointer"}} onClick={handleLogOut} className="flex md:w-[142px] max-md:justify-start max-md:gap-4 max-md:items-start md:h-[50px] md:items-center md:justify-center flex-row gap-1"><img src="log_out.png" alt="your orders" /><span>Log out</span></div>
            </div>
        </>
    )
}