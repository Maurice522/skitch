    ...
    return (
        <div className="flex flex-row gap-3 max-lg:-ml-4 max-lg:border max-lg:rounded-lg max-lg:gap-2 max-lg:flex-wrap">
            <div className="flex flex-col max-lg:m-1 max-lg:w-[40vw] md:w-[20vw] order-1 max-lg:order-1">
                <img src="Burg_King.jpg" className="max-lg:w-[200px] max-lg:h-[200px] w-[127px] h-[139px] rounded-2xl" />
                <div className="flex flex-row self-center items-center justify-center -top-4 bg-white w-[92px] gap-1 relative rounded-[4px] border-[#F59428] border border-solid">
            ...
            <div className="flex flex-col max-lg:mt-2 max-lg:w-[50vw] order-2 max-lg:order-2">
                <img src="veg.png" alt="veg" className="w-[17px] h-[17px]" />
                <span className="text-base font-medium font-nav">Veg Whopper</span>
                <img src="menu_star.png" className="w-[111px] h-[25px]" />
                <span>Lorem ipsum dolor sit amet consectetur. Laoreet sagittis at iaculis pulvinar.</span>
            </div>
