export default function SideDrawer(props) {
    ...
    return (
        <div id="sideDrawer" style={{ visibility: props.open ? "visible" : "hidden", }} className="fixed ml-2 top-0 left-0 bg-white p-4 h-screen w-[45%] flex z-50 flex-col gap-4">
            <div className="border-b-2 border-solid w-[50%] border-black">
                <span>SORT BY</span>
            </div>
            <div className="flex flex-row w-[75%] z-[3784734]">
            ...
            <div className="flex mt-6 flex-row w-[75%] z-[3784734]">
                <button className="text-[#DC3535]">Clear All</button>
                <button className="ml-auto p-1 w-[20%] text-gray-500 border border-solid border-gray-500 rounded-lg">Apply</button>
            </div>
        </div>
    )
}