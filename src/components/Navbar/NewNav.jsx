    ...
    return (
        <div className="overflow-x-hidden">
            <nav className="w-screen">
                <div className="flex max-lg:hidden flex-row bg-white max-md:h-[47px] h-[103px] shadow-nav items-center text-center">
                    ...
                    <div className="flex flex-row ml-auto mr-12 sm:gap-3 basis-1/2">
                        <button onClick={login} className="border border-solid sm:ml-auto border-[#F59428] font-nav font-medium text-base leading-5 rounded-md sm:p-4 w-[122px]">Log In</button>
                        <button onClick={signup} className="border border-solid border-[#F59428] sm:mr-5  font-nav font-medium text-base leading-5 rounded-md sm:p-4 w-[122px]">Sign Up</button>
                    </div>
                </div>                
