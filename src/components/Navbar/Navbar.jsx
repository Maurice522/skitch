  ...
  return (
    <nav className="w-screen">
        <div className="flex flex-row bg-white max-md:h-[47px] h-[103px] shadow-nav items-center text-center">
          ...
          <span className="font-nav font-normal max-md:w-[126px] max-md:h-[11px] w-[212px] h-[17px] max-md:text-[10px] max-md:leading-[14px] text-base absolute max-md:left-[107px] left-[310px] max-md:top-[23px] top-[63px] max-md:tracking-nav1 tracking-nav leading-6 drop-shadow-nav text-black">
            FUN FOOD & FRENZ
          </span>
        </div>
    </nav>
