...
const signInWithGoogle = async() => {
    signInWithPopup(auth, provider)
      .then((userCredential) => {
        ...
        createUserInDataBase(auth.currentUser.email,{name:auth.currentUser.displayName,
            email: auth.currentUser.email,
            phone:"",
            password:""})
      }).then(() => {
            ...
            >
                ...
                <div>
                    <form onSubmit={handleSignup}>
                        ...
                        <button disabled={loading} type="submit" className="relative top-[65px] max-sm:left-[60%] text-[#808080] w-[109px] h-[46px] left-[70%] bg-[#F3F3F3] border font-nav font-normal text-base border-solid border-[#E1E1E1]">SignUp</button>
                    </form>
                </div>
