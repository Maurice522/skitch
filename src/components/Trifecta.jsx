export default function Trifecta() {
  return (
    <div className="flex flex-col gap-12 items-center text-center max-sm:w-[341px] max-sm:text-left max-sm:ml-4">
      ...
      <div className="relative bg-tri max-sm:bg-cover bg-no-repeat bg-center max-sm:w-[250px] max-sm:h-[210px] w-[834px] h-[623px] absolute top-[200%] sm:max-md:left-0">
        <span className="absolute max-sm:w-[278px] max-sm:h-[32px] max-sm:text-5xl max-sm:leading-[22px] top-[55%] h-[32px] left-0 italic font-bold font-nav text-[200px] leading-[22px] text-center text-[#EFEFEF] text-opacity-[0.85] drop-shadow-skitch border-solid border-[#DEDEDE]">
          SKITCH
        </span>
        ...
        <div className="absolute max-sm:rounded-lg left-[38%] max-sm:left-[30%] max-sm:top-[-18%] top-[-5%] bg-[#747786] rounded-card shadow-grpcard p-2 max-sm:w-[116px] max-sm:h-[120px] max-sm:p-0">
          ...
          <br></br>
          <span className="font-nav font-medium text-sm leading-[18px] text-white max-sm:text-[7px] max-sm:leading-[10px]">
            We offer new food trading
          </span>
          <img
            alt=""
            src="/image 44.jpg"
        ...
        <div className="absolute max-sm:w-[116px] max-sm:rounded-lg max-sm:h[240px] bottom-[-23%] max-sm:bottom-[-20%] max-sm:left-[70%] left-[72%] bg-[#AFAFAF] rounded-card shadow-grpcard max-sm:p-0 p-2">
          ...
          <br></br>
          <span className="font-nav font-medium text-sm leading-[18px] text-white max-sm:text-[7px] max-sm:leading-[10px]">
            We Offer Transparency in Rating
          </span>
          <img
            alt=""
            src="/image 44(2).jpg"
