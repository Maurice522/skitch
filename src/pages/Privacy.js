...
const Privacy = () => {
  return (
    <div className="my-16 ml-14">
      <h1 className="text-4xl font-semibold">Privacy Policy</h1>
      <div className="flex flex-col mt-16 lg:w-10/12 lg:ml-16  md:mr-16  w-11/12 ">
        <div className="mb-4">
          ...
          <p className="text-base">
            ...
            register with us. When you register with us and use the Application,
            you generally provide (a) your name, email address, age, user name,
            ...
            or download or use applications from us; (c) information you provide
            us when you contact us for help; (d) credit card information for
            purchase and use of the Application, and; (e) information you enter
            into our system when using the Application, such as contact
            information and project management information. We may also use the
        ...
        <div className="mb-4">
          ...
          <p className="text-base">
            ...
            process; when we believe in good faith that disclosure is necessary
            ...
            If Razorpay India Pvt. Ltd is involved in a merger, acquisition, or
        ...
        <div className="mb-4">
          ...
          <p className="text-base">
            ...
            the mobile application marketplace or network. You can also request
            to opt-out via email, at Connect@skitch.in.
          </p>
        </div>
        <div className="mb-4">
          <h3 className="text-3xl mb-3 font-medium">
          ...
          <p className="text-base">
            ...
            please contact us at Connect@skitch.in and we will respond in a
        ...
        <div className="mb-4">
          <h3 className="text-3xl mb-3 font-medium">Children</h3>
          <p className="text-base">
            ...
            Connect@skitch.in. We will delete such information from our files
            within a reasonable time.
          </p>
        </div>
        <div className="mb-4">
          <h3 className="text-3xl mb-3 font-medium">Security</h3>
          <p className="text-base">
            ...
            although we endeavor to provide reasonable security for information
            we process and maintain, no security system can prevent all
            potential security breaches.
          </p>
        </div>
        <div className="mb-4">
          <h3 className="text-3xl mb-3 font-medium">Changes</h3>
          <p className="text-base">
        ...
        <div className="mb-4">
          <h3 className="text-3xl mb-3 font-medium">Your Consent</h3>
          <p className="text-base">
            ...
            in India. If you reside outside the United States your information
            will be transferred, processed and stored there under India privacy
            standards.
          </p>
        </div>
        <div className="mb-4">
          <h3 className="text-3xl mb-3 font-medium">Contact us</h3>
          <p className="text-base">
            If you have any questions regarding privacy while using the
            Application, or have questions about our practices, please contact
            us via email at Connect@skitch.in
          </p>
        </div>
      </div>
    </div>
